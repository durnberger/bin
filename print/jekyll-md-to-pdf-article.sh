...
echo
echo -e "---------------------------------------------------"
echo -e "------ Convert a Jekyll markdown file to PDF ------"
echo -e "---------------------------------------------------"
echo
echo -e "This script will convert a 'markdown' file produced"
echo -e "as part of one of my Jekyll project to a 'pdf'. It"
echo -e "is specifically designed to work with my preferred"
